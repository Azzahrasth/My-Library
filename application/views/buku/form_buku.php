<div class="col-md-12">        
     <div class="box box-info">
        ...
        <form method="post" action="<?=base_url()?>index.php/buku/simpan"class="form-horizontal">
                <div class="form-group">
                    <label for="inputPassword3" class="col-sm-2 control-label">Id Buku</label>
                    <div class="col-sm-10">
                        <input type="text"name="id_buku" value="<?=$id_buku;?>" class="form-control" >
                    </div>
                </div>
                ...
                <div class="box-footer">
                    <a href="<?=base_url()?>index.php/buku" class="btn btn-warning">Cancel</a>
