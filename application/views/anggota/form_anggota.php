<div class="col-md-12">        
     <div class="box box-info">
        ...
        <!-- diarahkan ke controller anggota function simpan -->
        <form method="post" action="<?=base_url()?>index.php/anggota/simpan"class="form-horizontal">
                <div class="box-body">
                    <div class="form-group">
                    <label for="inputEmail3" class="col-sm-2 control-label">Id Anggota</label>
                    <div class="col-sm-10">
                        <input type="text" name="id_anggota" value="<?= $id_anggota;?>" class="form-control">
                    </div>
                </div>
                ...
                <div class="box-footer">
                    <a href="<?=base_url()?>index.php/anggota" class="btn btn-warning">Cancel</a>
