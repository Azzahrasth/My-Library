            ...
            <div class="box-header">
                <form method="post" action="<?=base_url()?>index.php/laporan/peminjaman">
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <a href="<?=base_url()?>index.php/laporan/peminjaman" class="btn btn-warning btn-block btn-refresh"><i class="fa fa-refresh"></i> Refresh </a>
                        </div>
                        <div class="col-md-2">
                            <a href="<?=base_url()?>index.php/laporan/pdf_peminjaman" class="btn btn-primary btn-block btn-pdf" target="_blank"><i class="fa fa-file-pdf-o"></i> View PDF</a>
                        </div>
                    </div>
                </form>
            </div>
