...
$table1 = '<table border="0" width="650px">';
    $table1.='<tr>
                    <td style="text-align:center; font-family:sans-serif; font-size:16px; font-weigth:bold;">LAPORAN PENGEMBALIAN BUKU</td>
              </tr>';
$table1 .='</table> <br>';

$table2 = '<table border="1" width="650px">';
    $table2.='<tr style="background-color:lavender">
                    <td height="30" style="text-align:center; font-weight:bold; font-family:sans-serif; font-size:14px;">Peminjam</td>
                    ...
                    <td style="text-align:center; font-weight:bold; font-family:sans-serif; font-size:14px;">Di Kembalikan</td>
              </tr>';
              foreach ($data as $row) {
                 $table2.='<tr>
                    ...
                    <td style="text-align:center; font-family:sans-serif; font-size:12px;">'.$row->tgl_pinjam.'</td>
                    <td style="text-align:center; font-family:sans-serif; font-size:12px;">'.$row->tgl_kembali.'</td>
                    <td style="text-align:center; font-family:sans-serif; font-size:12px;">'.$row->tgl_kembalikan.'</td>
              </tr>';
              }
$table2 .='</table>';
