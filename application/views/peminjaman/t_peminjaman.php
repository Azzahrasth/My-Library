...
<div class="col-md-12">        
     <div class="box box-info">
        ...
        <form method="post" action="<?=base_url()?>index.php/peminjaman/simpan"class="form-horizontal">
                ...
                <div class="box-footer">
                    <a href="<?=base_url()?>index.php/peminjaman" class="btn btn-warning">Cancel</a>
